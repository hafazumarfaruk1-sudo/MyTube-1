...
const assetLoader = _reactNativeNitroModules.NitroModules.createHybridObject('AssetLoader');
const tfliteModule = _reactNativeNitroModules.NitroModules.createHybridObject('TfliteModule');
 ...
 */
async function loadTensorflowModel(source, delegates) {
  let uri;
...
//# sourceMappingURL=loadTensorflowModel.js.map